    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(choices=[('Shipped', 'PShipped'), ('delivered', 'Delivered'), ('Process', 'Processing')], default='processing', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qty', models.IntegerField(verbose_name=False)),
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=99999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(choices=[('draft', 'Draft'), ('disabled', 'Disabled'), ('in_review', 'In_review'), ('published', 'Published'), ('rejected', 'Rejected')], default='in_review', max_length=10)),
